...
extern zbar_image_t *zbar_image_filter(const zbar_image_t *src, zbar_image_t *dst, const short *kernel);
extern zbar_image_t *zbar_image_diff(const zbar_image_t *src, const zbar_image_t *sub, zbar_image_t *dst);
extern zbar_image_t *zbar_image_blur (const zbar_image_t *src, zbar_image_t *dst, int r);
extern zbar_image_t *zbar_image_adjust(const zbar_image_t *src, zbar_image_t *dst, double gain, double bias);
extern zbar_image_t *zbar_image_unsharp_mask (const zbar_image_t *src, double amount, double radius, double threshold);
...
extern int zbar_scan_image(zbar_image_scanner_t *scanner,
                           zbar_image_t *image);
extern int zbar_scan_image_rot(zbar_image_scanner_t *scanner,
                           zbar_image_t *image);
